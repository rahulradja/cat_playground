import { List, FancyButton } from "@pixi/ui";
...
import { UIBox, DefaultUIBoxSettings } from "../ui/UIBox"
import { defaultUIButtonSettings } from "../ui/UiButton"
...
export class SettingsPopup extends Container {
    ...
    constructor() {
        ...
        this.panel = new UIBox(DefaultUIBoxSettings);
        ...
        this.title.y = -this.panel.boxHeight * 0.5 + 60;
        this.panel.addChild(this.title);

        this.doneButton = new FancyButton(defaultUIButtonSettings("OK"))
        this.doneButton.y = this.panel.boxHeight * 0.5 - 78;
        ...
        this.versionLabel.y = this.panel.boxHeight * 0.5 - 15;
